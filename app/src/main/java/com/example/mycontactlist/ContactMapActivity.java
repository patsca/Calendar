...
public class ContactMapActivity extends AppCompatActivity implements OnMapReadyCallback {
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_LOCATION: {
                if (grantResults.length > 0 &&
                    ...
                    Toast.makeText(ContactMapActivity.this, "Calendar will not locate your contacts", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (contacts.size()>0) {
            ...
            gMap.animateCamera(CameraUpdateFactory.newLatLngBounds(builder.build(),
                                        measureWidth, measureHeight, 300));
        }
        else {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 23) {
                   if (ContextCompat.checkSelfPermission(getBaseContext(),
                    ...
                    Snackbar.make(findViewById(R.id.activity_contact_map),
                            "Calendar requires this permission to locate " +
            ...
            Toast.makeText(getBaseContext(), "Error request permission",
    ...
    private void initListButton() {
        ImageButton imageSettingsButton = findViewById(R.id.imageButtonList);
        imageSettingsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
